...
//      "producer.type";
    public static final String KEY_SERIALIZER = KAFKA_CONFIG_PREFIX +
            "key.serializer";
    public static final String VALUE_SERIALIZER = KAFKA_CONFIG_PREFIX +
            "value.serializer";

    public static final String KEY_DESERIALIZER = KAFKA_CONFIG_PREFIX +
            "key.deserializer";
    public static final String VALUE_DESERIALIZER = KAFKA_CONFIG_PREFIX +
            "value.deserializer";
...
//    default_map.put(PRODUCER_TYPE, "async");
        default_map.put(KEY_SERIALIZER, "org.apache.kafka.common.serialization.StringSerializer");
        default_map.put(VALUE_SERIALIZER, "org.apache.kafka.common.serialization.ByteArraySerializer");

        default_map.put(KEY_DESERIALIZER, "org.apache.kafka.common.serialization.ByteArrayDeserializer");
        default_map.put(VALUE_DESERIALIZER, "org.apache.kafka.common.serialization.ByteArrayDeserializer");
