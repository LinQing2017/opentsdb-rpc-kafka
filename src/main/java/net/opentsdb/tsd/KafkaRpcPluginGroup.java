...
public class KafkaRpcPluginGroup implements TimerTask {
    ...
    public KafkaRpcPluginGroup(final KafkaRpcPlugin parent, final String groupID) {
        ...
        LOG.info("Debug Message by lqing: " + groupID);
        ...
        LOG.info("Debug Message by lqing: " + topics);
        ...
        LOG.info("Debug Message by lqing: " + type);
        ...
        LOG.info("Debug Message by lqing: " + deser_class);
        ...
        for (int i = 0; i < num_threads; i++) {
            LOG.info("Debug message by lqing: " + "Init KafkaRpcPluginThread " + i);
            kafka_consumers.add(new KafkaRpcPluginThread(this, i, topics));
        }
        LOG.info("Debug message by lqing: " + "Init KafkaRpcPluginThread  Finished");
    ...
    public void start() {
        if (current_rate > 0) {
            LOG.info("Debug message by lqing: " + "Start kafka_consumers Thread");
